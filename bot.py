...
# ─────────────────────────────────────────
# ДАННЫЕ (ОГРОМНАЯ БАЗА ВОПРОСОВ)
# ─────────────────────────────────────────
QUESTIONS = {
    "padawan": [
        {"q":"Какого цвета световой меч у Йоды?","o":["Зелёный","Синий","Красный","Фиолетовый"],"a":0,"p":10,"d":1},
        {"q":"Кто сказал 'Я — твой отец'?","o":["Палпатин","Дарт Мол","Дарт Вейдер","Граф Дуку"],"a":2,"p":10,"d":1},
        {"q":"На какой планете вырос Люк Скайуокер?","o":["Корусант","Татуин","Набу","Эндор"],"a":1,"p":10,"d":1},
        {"q":"Кто пилотировал Миллениум Фэлкон?","o":["Люк","Лэндо","Хан Соло","Чубакка"],"a":2,"p":10,"d":1},
        {"q":"Какое оружие используют джедаи?","o":["Бластер","Световой меч","Вибромеч","Снайперская винтовка"],"a":1,"p":10,"d":1},
        {"q":"Кто такой Чубакка?","o":["Дроид","Вуки","Мандалорец","Тогрута"],"a":1,"p":10,"d":1},
        {"q":"Как называется орден Светлой стороны?","o":["Ситхи","Мандалорцы","Джедаи","Республиканцы"],"a":2,"p":10,"d":1},
        {"q":"Цвет меча Дарта Вейдера?","o":["Синий","Зелёный","Красный","Фиолетовый"],"a":2,"p":10,"d":1},
        {"q":"Как зовут мастера-джедая, похожего на черепаху?","o":["Йода","Пло Кун","Мейс Винду","Оби-Ван"],"a":0,"p":10,"d":1},
        {"q":"Какая планета полностью покрыта городом?","o":["Татуин","Набу","Корусант","Камино"],"a":2,"p":10,"d":1},
        {"q":"Кто правил Галактикой как Император?","o":["Дарт Вейдер","Граф Дуку","Палпатин","Таркин"],"a":2,"p":10,"d":1},
        {"q":"Кто такой R2-D2?","o":["Протокол-дроид","Астромеханический дроид","Боевой дроид","Охотник за головами"],"a":1,"p":10,"d":1},
        
        {"q":"Кто убил Дарта Мола в Эпизоде 1?","o":["Йода","Оби-Ван","Квай-Гон","Палпатин"],"a":1,"p":15,"d":2},
        {"q":"Из чего состоит армия Республики в Войне Клонов?","o":["Дроидов","Клонов","Мандалорцев","Волонтёров"],"a":1,"p":15,"d":2},
        {"q":"Как называется родная планета Чубакки?","o":["Эндор","Кашyyк","Татуин","Хот"],"a":1,"p":15,"d":2},
        {"q":"Кто тренировал Оби-Вана Кеноби?","o":["Йода","Квай-Гон Джинн","Мейс Винду","Кит Фисто"],"a":1,"p":15,"d":2},
        {"q":"Кто такой Джар-Джар Бинкс?","o":["Дроид","Гунган","Люди-рыба","Ситх"],"a":1,"p":15,"d":2},
        {"q":"Какая организация управляет Галактикой до Империи?","o":["Сепаратисты","Галактическая Республика","Орден Джедаев","Торговая Федерация"],"a":1,"p":15,"d":2},
        {"q":"Кто такая Падме Амидала?","o":["Джедай","Королева/Сенатор Набу","Охотница за головами","Ситх"],"a":1,"p":15,"d":2},
        {"q":"Какой корабль разрушает Альдераан?","o":["Звезда Смерти","Исполнительный","ТИЕ-Истребитель","Суперзвезда Смерти"],"a":0,"p":15,"d":2},
        {"q":"Кто такой Боба Фетт?","o":["Клон","Джедай","Ситх","Дроид"],"a":0,"p":15,"d":2},
        {"q":"На какой планете находится ледяная база повстанцев в Эп. 5?","o":["Хот","Дагоба","Татуин","Эндор"],"a":0,"p":15,"d":2},
        {"q":"Кто спас Хана Соло из карбонита?","o":["Люк","Лэндо","Лея","Чубакка"],"a":1,"p":15,"d":2},

        {"q":"Какой приказ уничтожил большинство джедаев?","o":["Приказ 65","Приказ 66","Приказ 99","Приказ 77"],"a":1,"p":20,"d":3},
        {"q":"Кто тайно заказал создание армии клонов?","o":["Палпатин","Сифо-Диас","Дарт Тиранус","Сифо-Диас и Тиранус"],"a":3,"p":20,"d":3},
        {"q":"Какое реальное имя Дарта Сидиуса?","o":["Шив Палпатин","Дарт Плэгас","Финис Валорум","Хас Визла"],"a":0,"p":20,"d":3},
        {"q":"Какой расы был Дарт Мол?","o":["Забрак","Тогрута","Миралука","Человек"],"a":0,"p":20,"d":3},
        {"q":"Кто вырастил Анакина Скайуокера как раба?","o":["Ватто","Гарджа","Себастьян Шоу","Квай-Гон"],"a":0,"p":20,"d":3},
        {"q":"Сколько лет длилась Война Клонов?","o":["1 год","3 года","5 лет","10 лет"],"a":1,"p":20,"d":3},
        {"q":"Кто убил Джанго Фетта?","o":["Оби-Ван","Мейс Винду","Йода","Боба Фетт"],"a":1,"p":20,"d":3},
        {"q":"Какой дроид-ассасин пытался убить Падме в Эпизоде 2?","o":["IG-88","Боба Фетт","ЗAM-Веселл","R2-D2"],"a":2,"p":20,"d":3},
        {"q":"На какой планете Оби-Ван и Анакин сражаются с Дуку первый раз?","o":["Дженона","Корусант","Геонозис","Мустафар"],"a":2,"p":20,"d":3},
        {"q":"Какое животное оседлал Анакин на Набу?","o":["Воркон","Фаба","Таунтаун","Дрого"],"a":0,"p":20,"d":3},
        {"q":"Кто такой Нут Ганрей?","o":["Ситх","Вице-король Торговой Федерации","Джедай","Сенатор"],"a":1,"p":20,"d":3},
    ],
    "jedi": [
        {"q":"Где находится Храм джедаев?","o":["Набу","Дагоба","Корусант","Илум"],"a":2,"p":20,"d":1},
        {"q":"Цвет светового меча Мейса Винду?","o":["Синий","Зелёный","Фиолетовый","Красный"],"a":2,"p":20,"d":1},
        {"q":"Кто такая Асока Тано?","o":["Ситх","Падаван Энакина","Сенатор","Наёмник"],"a":1,"p":20,"d":1},
        {"q":"Что такое Голокрон?","o":["Корабль","Хранилище знаний Силы","Оружие","Планета"],"a":1,"p":20,"d":1},
        {"q":"Как называется раса Асоки Тано?","o":["Твилек","Тогрута","Миралука","Забрак"],"a":1,"p":20,"d":1},
        {"q":"Кто такой Капитан Рекс?","o":["Дроид","Клон-командир","Штурмовик","Мандалорец"],"a":1,"p":20,"d":1},
        {"q":"Какой меч был у Дарта Мола изначально?","o":["Один красный","Двойной красный","Синий и красный","Черный"],"a":1,"p":20,"d":1},
        {"q":"Кто предал Орден и стал лордом ситхов в Эпизоде 2?","o":["Анакин","Дуку","Сифо-Диас","Пло Кун"],"a":1,"p":20,"d":1},
        {"q":"Как называется планета-болото, где скрывался Йода?","o":["Дагоба","Фелуция","Камино","Мустафар"],"a":0,"p":20,"d":1},
        {"q":"Кто такой Канан Джаррус?","o":["Мастер-джедай","Падаван, выживший в Приказе 66","Ситх","Клон"],"a":1,"p":20,"d":1},
        {"q":"Как зовут сына Хана Соло и Леи?","o":["Кайло Рен","Бен Соло","Энакин","Хан Соло мл."],"a":1,"p":20,"d":1},
        {"q":"Кто такая Асадж Вентресс?","o":["Джедай","Ученица Дуку","Ситх","Сенатор"],"a":1,"p":20,"d":1},
        
        {"q":"Что такое мидихлорианы?","o":["Оружие ситхов","Микроорганизмы Силы","Вид инопланетян","Двигатель"],"a":1,"p":30,"d":2},
        {"q":"Кто такая Сатин Крайз?","o":["Джедай","Ситх","Мандалорка-пацифист","Бойница-клон"],"a":2,"p":30,"d":2},
        {"q":"Какой расы был Сев Тарс (друг Энакина)?","o":["Человек","Твилек","Миралука","Тогрута"],"a":1,"p":30,"d":2},
        {"q":"Кто такие 'Ночные Совы'?","o":["Элитные клоны","Темные джедаи","Культ ситхов","Дроиды"],"a":0,"p":30,"d":2},
        {"q":"На какой планете джедаи добывают кристаллы для мечей?","o":["Корусант","Мустафар","Илум","Татуин"],"a":2,"p":30,"d":2},
        {"q":"Кто такой Саваж Опресс?","o":["Брат Дарта Мола","Клон","Джедай","Хатт"],"a":0,"p":30,"d":2},
        {"q":"Что произошло с Асокой в финале 5 сезона Клоновых войн?","o":["Погибла","Ушла из Ордена","Стала ситхом","Попала в плен"],"a":1,"p":30,"d":2},
        {"q":"Кто такой генерал Гривус?","o":["Киборг-главнокомандующий дроидов","Ситх","Клон","Хатт"],"a":0,"p":30,"d":2},
        {"q":"В каком братстве состояла Вентресс после ухода от Дуку?","o":["Орден Ситхов","Сестры Ночи","Мандалорцы","Инквизиторы"],"a":1,"p":30,"d":2},
        {"q":"Кто убийца Сифо-Диаса (канонично)?","o":["Дарт Мол","Дарт Сидиус","Дарт Плегас","Дарт Тиранус"],"a":1,"p":30,"d":2},
        {"q":"Как называется корабль Энакина и Асоки?","o":["Наблюдатель","Тень","Гостеприимный","Сокол"],"a":0,"p":30,"d":2},

        {"q":"Раса Йоды (по канону)?","o":["Квермийцы","Тогрутане","Не раскрыта","Миральцы"],"a":2,"p":40,"d":3},
        {"q":"Сколько членов Совета Джедаев было постоянно?","o":["10","12","15","5"],"a":1,"p":40,"d":3},
        {"q":"Какое преступление совершил Энакин после смерти Шми?","o":["Убил Ватто","Убил племя тускенов","Сжег ферму","Убил Шоу"],"a":1,"p":40,"d":3},
        {"q":"Кто такой Дарт Плэгас Мудрый?","o":["Учитель Сидиуса","Первый ситх","Ученик Мола","Джедай"],"a":0,"p":40,"d":3},
        {"q":"Кто создал правило 'Только двое' (Ситхов)?","o":["Дарт Бейн","Дарт Сидиус","Дарт Нихилус","Дарт Реван"],"a":0,"p":40,"d":3},
        {"q":"Как называется темная сторона (где живут Авторы Силы)?","o":["Дагоба","Мортис","Коррибан","Мустафар"],"a":1,"p":40,"d":3},
        {"q":"Кто из Джедаев первым применил молнию Силы (в легендах)?","o":["Йода","Мейс Винду","Пло Кун","Лук Сайлер"],"a":1,"p":40,"d":3},
        {"q":"Какая форма боя была у Дарта Мола?","o":["Шиен","Джар'Кай","Джуйсо","Сорцу"],"a":1,"p":40,"d":3},
        {"q":"Кто такая Талзин (Мать)?","o":["Ситх","Джедай","Лидер сестер ночи","Охотница"],"a":2,"p":40,"d":3},
        {"q":"Что случилось с Зейном после Приказа 66?","o":["Погиб","Потерял память","Остался верен Империи","Стал Инквизитором"],"a":1,"p":40,"d":3},
        {"q":"Какой планетой управлял Кад Бейн?","o":["Татуин","Конкорд Даун","Датомер","Ондерон"],"a":1,"p":40,"d":3},
        {"q":"Кто такой Реван (до падения)?","o":["Ситх","Джедай-Мастер","Клон","Мандалорец"],"a":1,"p":40,"d":3},
    ],
    "master": [
        {"q":"Мать Энакина Скайуокера?","o":["Падме","Шми","Бару","Лира"],"a":1,"p":40,"d":1},
        {"q":"Кто озвучил Дарта Вейдера в оригинальной трилогии?","o":["Марк Хэмилл","Джеймс Эрл Джонс","Харрисон Форд","Дэвид Прауз"],"a":1,"p":40,"d":1},
        {"q":"Что такое Дарксейбер?","o":["Красный меч","Черный меч Мандалора","Меч Бейна","Артефакт Йоды"],"a":1,"p":40,"d":1},
        {"q":"Кто такая Бо-Катан Крайз?","o":["Джедай","Ситх","Мандалорка","Сенатор"],"a":2,"p":40,"d":1},
        {"q":"Кто создал правило двух ситхов?","o":["Дарт Бейн","Дарт Плэгас","Тенебрус","Сидиус"],"a":0,"p":40,"d":1},
        {"q":"Из чего делают мандалорскую броню?","o":["Дюраниум","Бескар","Титан","Кортозис"],"a":1,"p":40,"d":1},
        {"q":"Кто такой Гранд Мофф Таркин?","o":["Ситх","Джедай","Командующий Звезды Смерти","Охотник"],"a":2,"p":40,"d":1},
        {"q":"Какой ситх тренировал Дарта Мола (по канону)?","o":["Сидиус","Плегас","Тиранус","Снока"],"a":0,"p":40,"d":1},
        {"q":"Кто такой Эзра Бриджер?","o":["Джедай Республики","Юный падаван из Rebels","Мандалорец","Клон"],"a":1,"p":40,"d":1},
        {"q":"Какая группа охотников за головами есть в Мандалорце?","o":["Боба Фетт","Клан Крайт","Инквизиторы","Гильдия"],"a":1,"p":40,"d":1},
        {"q":"Кто такой Роук?","o":["Дроид","Джедай-падаван","Мандалорец","Штурмовик"],"a":1,"p":40,"d":1},
        {"q":"Кто такой Гоган (Grogu)?","o":["Злодей","Детеныш расы Йоды","Дроид","Клон"],"a":1,"p":40,"d":1},

        {"q":"Мандалорский кодекс чести?","o":["Дин Джарин","Резол-наре","Бескар","Ковата"],"a":1,"p":60,"d":2},
        {"q":"Кто такой Палпатин ДО того, как стал канцлером?","o":["Сенатор Набу","Сенатор Корусанта","Губернатор","Джедай"],"a":0,"p":60,"d":2},
        {"q":"Как называется судно, на котором Палпатин спасся от смерти?","o":["Звезда Смерти","Затмение","Исполнительный","Нексус"],"a":1,"p":60,"d":2},
        {"q":"Какая форма боевого стиля у Оби-Вана Кеноби?","o":["Атару","Сорцу","Соору","Макаси"],"a":2,"p":60,"d":2},
        {"q":"Кто такой Дарт Нихилус?","o":["Человек","Тень, пожирающий миры","Дроид","Инквизитор"],"a":1,"p":60,"d":2},
        {"q":"Как называется древний храм ситхов на Морабанде?","o":["Храм Сидиуса","Академия Бейна","Гробница Дартомира","Затмение"],"a":2,"p":60,"d":2},
        {"q":"Кто такая Сноук?","o":["Ситх","Претензия на власть Палпатина","Джедай","Клон Вейдера"],"a":1,"p":60,"d":2},
        {"q":"Как называется орден теневых убийц Империи?","o":["Штурмовики","Инквизиторы","Дарк Труперы","Гварда"],"a":1,"p":60,"d":2},
        {"q":"Какая планета была разрушена для создания Звезды Смерти?","o":["Альдераан","Джедха","Илум","Кореллия"],"a":1,"p":60,"d":2},
        {"q":"Кто убийца Шми Скайуокер?","o":["Дарт Мол","Племя тускенов","Дарт Вейдер","Боба Фетт"],"a":1,"p":60,"d":2},
        {"q":"Кто такая Миттра Сурик (Мисс Светлая)?","o":["Ситх","Джедай-Генерал","Мандалорка","Дроид"],"a":1,"p":60,"d":2},

        {"q":"Какой лорд ситхов обучал Дарта Плагиаса?","o":["Дарт Тенебрус","Дарт Бейн","Дарт Сидиус","Дарт Нихилус"],"a":0,"p":80,"d":3},
        {"q":"Кто граф Дуку на самом деле (титул ситха)?","o":["Дарт Мол","Дарт Тиранус","Дарт Сидиус","Дарт Вейдер"],"a":1,"p":80,"d":3},
        {"q":"Что произошло с Энакином на Мустафаре?","o":["Потерял руку","Потерял ноги","Попал в лаву","Утонул"],"a":2,"p":80,"d":3},
        {"q":"Как называется древняя раса, создавших гипердрайв?","o":["Люди","Раката","Чисс","Келл-Дроиды"],"a":1,"p":80,"d":3},
        {"q":"Кто такой Дарт Реван до падения?","o":["Мандалорец","Джедай-Мастер","Сенатор","Клон"],"a":1,"p":80,"d":3},
        {"q":"Кто такой Небула Сноук (по канону)?","o":["Клон Палпатина","ИИ","Ученик Люка","Сын Леи"],"a":0,"p":80,"d":3},
        {"q":"Кто спас Дарта Вейдера с Мустафара?","o":["Оби-Ван","Палпатин","Таркин","Моли"],"a":1,"p":80,"d":3},
        {"q":"Какая планета - родина мандалорцев?","o":["Конкорд Даун","Мандалор","Корусант","Мандо'аир"],"a":1,"p":80,"d":3},
        {"q":"Кто такая Бастила Шан?","o":["Ситх","Джедай-тень","Мандалорка","Дроид"],"a":1,"p":80,"d":3},
        {"q":"Какая 'Долина' является источником огромной силы Силы?","o":["Долина Джедаев","Долина Силы","Долина Смерти","Долина Тьмы"],"a":0,"p":80,"d":3},
        {"q":"Кто убил Дарта Сидиуса окончательно (в Эпизоде 9)?","o":["Рей","Кайло Рен","Люк","Финн"],"a":0,"p":80,"d":3},
    ]
}
...
async def send_duel_question(context, chat_id, duel_id, q_index, duel):
    ...
    text = (
        f"⚔️ Дуэль: {p1_name} {duel['p1s']} — {duel['p2s']} {p2_name}\n"
...
async def btn(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if d.startswith("da_"):
        ...
        await q.answer(f"{'✅ Верно! +'+str(points) : '❌ Неверно'}", show_alert=True)
        ...
        if duel["p1a"] and duel["p2a"]:
            ...
            if next_index < len(duel["questions"]):
                ...
                try:
                    p1_name = (await context.bot.get_chat(d_final["p1"])).first_name
                    p2_name = (await context.bot.get_chat(d_final["p2"])).first_name
                except: p1_name, p2_name = "Игрок 1", "Игрок 2"

                res = f"🤝 Ничья!\n{p1_name}: {d_final['p1s']} — {d_final['p2s']} {p2_name}"
                if d_final["p1s"] > d_final["p2s"]:
                    res = f"🏆 Победил {p1_name}!\n{p1_name}: {d_final['p1s']} — {d_final['p2s']} {p2_name}"; add_result(d_final["p1"], 50, True)
                elif d_final["p2s"] > d_final["p1s"]:
                    res = f"🏆 Победил {p2_name}!\n{p1_name}: {d_final['p1s']} — {d_final['p2s']} {p2_name}"; add_result(d_final["p2"], 50, True)

                await context.bot.send_message(d_final["chat_id"], f"⚔️ Дуэль завершена!\n\n{res}\n\nПобедитель +50 монет 🪙", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🏠 Меню", callback_data="menu")]]))
        ...
        kb = [[InlineKeyboardButton("📦 Открыть пак (50 монет)", callback_data="open_pack")],[InlineKeyboardButton("◀️ Меню", callback_data="menu")]]
        await q.edit_message_text(f"🛒 Магазин карточек\n\nУ тебя: {row[3]} монет 🪙\n\n⚪ Обычные - 45%\n🔹 Редкие - 50%\n🟡 Легендарные - 5%", reply_markup=InlineKeyboardMarkup(kb))

    elif d == "open_pack":
        if not spend_coins(user.id, 50): return await q.answer("❌ Недостаточно монет!", show_alert=True)
        
        roll, current_chance, chosen_rarity = random.randint(1, 100), 0, "common"
        ...
        bonus = 0
        if not is_new: bonus = 25; add_result(user.id, bonus, False)

        rarity_names = {"common": "Обычная", "rare": "Редкая", "legendary": "Легендарная"}
        text = f"🎉 Выпала карточка!\n\n{card['emoji']} {card['name']}\nРедкость: {rarity_names[card['rarity']]}\nСторона: {card['side']}\n\n«{card['quote']}»"
        if not is_new: text += f"\n\n⚡ Дубль! Возвращено {bonus} монет."

        kb = [[InlineKeyboardButton("📦 Ещё пак", callback_data="open_pack")],[InlineKeyboardButton("🎴 Коллекция", callback_data="collection")],[InlineKeyboardButton("◀️ В магазин", callback_data="shop")]]
        try:
            await context.bot.send_photo(chat_id=q.message.chat_id, photo=card["img"], caption=text, reply_markup=InlineKeyboardMarkup(kb))
            await q.message.delete()
        except: await q.edit_message_text(text, reply_markup=InlineKeyboardMarkup(kb))

    elif d == "collection":
        owned = get_cards(user.id)
        if not owned:
            await q.edit_message_text("🎴 Коллекция пуста\n\nОткрывай паки в магазине!", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🛒 Магазин", callback_data="shop")],[InlineKeyboardButton("◀️ Меню", callback_data="menu")]]))
        else:
...
async def poll_answer(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if new_index < len(session["questions"]):
        try: await context.bot.send_message(user_id, result_text)
        except: pass
        try: await send_poll(context, user_id, user_id, session["questions"][new_index], new_index, len(session["questions"]), session["level"])
        except: pass
    else:
        del_session(user_id)
